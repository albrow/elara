...
"#
    ...
    fn initial_states(&self) -> Vec<State> {
        vec![
            ...
            State {
                player: Player::new(4, 0, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(8, 0, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(0, 3, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(0, 7, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(11, 0, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(11, 4, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(11, 7, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(7, 7, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
            ...
            State {
                player: Player::new(3, 7, 10, Orientation::Down),
                fuel_spots: vec![],
                goal: Some(Goal {
                    pos: Pos { x: 6, y: 3 },
                }),
