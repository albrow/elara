...
import { BP_2XL, BP_3XL, BP_XL, BODY_RESPONSIVE_FONT_SCALE, LEVEL_TITLE_HINT_BUTTON_LIGHTBULB_SIZE_2XL, LEVEL_TITLE_HINT_BUTTON_LIGHTBULB_SIZE_3XL, LEVEL_TITLE_HINT_BUTTON_LIGHTBULB_SIZE_BASE, LEVEL_TITLE_HINT_BUTTON_LIGHTBULB_SIZE_XL } from "../../lib/constants";
...
export default function ShowHintButton(props: ShowHintButtonProps) {
  ...
  return (
    <Tooltip fontSize={BODY_RESPONSIVE_FONT_SCALE} label="Show hint(s)" placement="right">
      <Button
        bg="blue.500"
        _hover={{ bg: "blue.600" }}
        _active={{ bg: "blue.700" }}
