...
Elara is a game that teaches you how to program. It is named after one of the
...
{/* NOTE(albrow): Will need to change this link manually if the first scene changes. */}

<Link to="/dialog/intro">
