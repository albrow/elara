...
example below assigns the output of the `random` function to a variable called
`random_number`.

<RunnableExample
  code={`// The random function outputs a random number, which we assign to a
// variable called random_number.
